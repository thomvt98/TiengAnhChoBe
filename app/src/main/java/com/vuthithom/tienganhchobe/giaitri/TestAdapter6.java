...
public class TestAdapter6 extends Activity implements View.OnClickListener {
    ...
    private void nextQuestion(int position) {
        ...
        ivTest1.getLayoutParams().height = 128;
        ivTest1.getLayoutParams().width = 128;


        ivTest2.setImageResource(test.getIdImg()[1]);
        ivTest2.getLayoutParams().height = 128;
        ivTest2.getLayoutParams().width = 128;

        ivTest3.setImageResource(test.getIdImg()[2]);
        ivTest3.getLayoutParams().height = 128;
        ivTest3.getLayoutParams().width = 128;

        ivTest4.setImageResource(test.getIdImg()[3]);
        ivTest4.getLayoutParams().height = 128;
        ivTest4.getLayoutParams().width = 128;

        tvTestNumber.setText("Câu hỏi số :" + (mIndext + 1) + "/" + list.size());
    }

    private void initQuesion6() {
        list.add(new TestLesson(
                new int[]{R.drawable.argentian, R.drawable.finland, R.drawable.belgium, R.drawable.brazil},
                "finland",
                new String[]{"argentian", "finland", "belgium", "brazil"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.croatia, R.drawable.cuba, R.drawable.finland, R.drawable.lao},
                "cuba",
                new String[]{"croatia", "cuba", "finland", "lao"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.netherlands, R.drawable.rossiya, R.drawable.singaporo, R.drawable.south_korea},
                "singaporo",
                new String[]{"netherlands", "rossiya", "singaporo", "south_korea"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.us, R.drawable.vietnamm, R.drawable.yemen, R.drawable.zimbabwe},
                "zimbabwe",
                new String[]{"us", "vietnamm", "yemen", "zimbabwe"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.australia, R.drawable.croatia, R.drawable.vietnamm, R.drawable.rossiya},
                "australia",
                new String[]{"australia", "croatia", "vietnam", "rossiya"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.singaporo, R.drawable.yemen, R.drawable.south_korea, R.drawable.argentian},
                "argentian",
                new String[]{"singaporo", "yemen", "south_korea", "argentian"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.brazil, R.drawable.lao, R.drawable.finland, R.drawable.netherlands},
                "brazil",
                new String[]{"brazil", "lao", "finland", "netherlands"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.lao, R.drawable.vietnamm, R.drawable.zimbabwe, R.drawable.croatia},
                "vietnam",
                new String[]{"us", "vietnam", "zimbabwe", "croatia"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.cuba, R.drawable.finland, R.drawable.belgium, R.drawable.brazil},
                "cuba",
                new String[]{"cuba", "finland", "belgium", "brazil"}
        ));
        list.add(new TestLesson(
                new int[]{R.drawable.australia, R.drawable.zimbabwe, R.drawable.yemen, R.drawable.belgium},
                "yemen",
                new String[]{"australia", "zimbabwe", "yemen", "belgium"}
        ));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ivTestSound:
                toSpeech = new TextToSpeech(TestAdapter6.this, new TextToSpeech.OnInitListener() {
                    @Override
    ...
    private void checkAnswer(String text) {
        ...
        if (mIndext == list.size()) {
            ...
            ivdialogtestnext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dialog.dismiss();
                    Intent intent = new Intent(TestAdapter6.this, TestAdapter7.class);
            ...
            ivdialogtestback.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(TestAdapter6.this, TestAdapter5.class);
                    startActivity(intent);
                }
            });
